...
class AbstractAddress(models.Model):
    ...
    def clean(self):
        ...
        for field in ['first_name', 'last_name', 'line1', 'line2', 'line3', 'line4',
                      'state', 'postcode']:
    ...
    def active_address_fields(self, include_salutation=True):
        ...
        """
        fields = [self.line1, self.line2, self.line3, self.line4,
...
class AbstractUserAddress(AbstractShippingAddress):
    ...
    user = models.OneToOneField(AUTH_USER_MODEL, related_name='addresses', verbose_name=_("User"))
